import { createRitual as createManagedRitual } from '/tarot/static/js/three/managed-cards3d-core.v6.js';

// Keep the v5 selection camera stable on crowded viewports, then apply the
// latest requested spread framing once every chosen card has landed.
...
export function createRitual(stage) {
  const ritual = createManagedRitual(stage);
